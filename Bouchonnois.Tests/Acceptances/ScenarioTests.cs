...
public class ScenarioTests
{
    ...
    public async Task DéroulerUnePartie()
    {
        ...
        After(30.MinutesLater(), () => _tirerSurGalinette.Handle(new TirerSurGalinetteRequest(id, "Robert")));
        ...
        After(1.MinutesLater(), () => _tirerSurGalinette.Handle(new TirerSurGalinetteRequest(id, "Dédé")));
        After(26.MinutesLater(), () => _tirerSurGalinette.Handle(new TirerSurGalinetteRequest(id, "Robert")));
        ...
        After(1.SecondsLater(), () => _tirer.Handle(id, "Bernard"));
        After(1.SecondsLater(), () => _tirer.Handle(id, "Bernard"));
        After(19.MinutesLater(), () => _tirerSurGalinette.Handle(new TirerSurGalinetteRequest(id, "Robert")));
